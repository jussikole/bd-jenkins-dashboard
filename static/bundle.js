...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardDashboardJsx = __webpack_require__(162);

	var _dashboardDashboardJsx2 = _interopRequireDefault(_dashboardDashboardJsx);
	...
	_react2['default'].render(_react2['default'].createElement(_dashboardDashboardJsx2['default'], null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardJsx = __webpack_require__(163);

	var _cardJsx2 = _interopRequireDefault(_cardJsx);

	var _projectJsx = __webpack_require__(164);

	var _projectJsx2 = _interopRequireDefault(_projectJsx);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        this.state.dashboard.jobs.map(function (job) {
	          return _react2['default'].createElement(_projectJsx2['default'], { details: job, style: styles.column });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildJsx = __webpack_require__(165);

	var _buildJsx2 = _interopRequireDefault(_buildJsx);

	var _lastBuildsJsx = __webpack_require__(166);

	var _lastBuildsJsx2 = _interopRequireDefault(_lastBuildsJsx);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { style: styles.header, className: 'center-align white-text' },
	          _react2['default'].createElement(
	            'h3',
	            null,
	            this.state.details.displayName
	          )
	        ),
	        _react2['default'].createElement(
	          'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_buildJsx2['default'], { build: this.state.details.lastBuild, ref: 'lastBuild', title: 'Last build' }),
	            _react2['default'].createElement(_buildJsx2['default'], { build: this.state.details.lastSuccessfulBuild, ref: 'lastSuccessfulBuild', title: 'Last successful build' }),
	            _react2['default'].createElement(_lastBuildsJsx2['default'], { builds: this.state.details.builds })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var readableBuildTime = function readableBuildTime(ms) {
	  var min = Math.floor(ms / 60000);
	  ms -= min * 60000;
	  var sec = Math.floor(ms / 1000);
	  if (min > 0) return min + ' min ' + sec + ' sec';else return sec + ' sec';
	};
	...
	var Build = (function (_React$Component) {
	  function Build(props) {
	    ...
	    _get(Object.getPrototypeOf(Build.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(Build, [{
	    ...
	    value: function createState(props) {
	      ...
	      var duration = props.build.building ? readableBuildTime(elapsed) : readableBuildTime(props.build.duration);
	      ...
	      return {
	        ...
	        items: [{ payload: 1, text: 'Started', value: new Date(props.build.timestamp).toString() }, { payload: 2, text: 'Duration', value: duration }, { payload: 3, text: 'Action', value: props.build.actions[0].causes[0].shortDescription }, { payload: 4, text: 'Result', value: props.build.result }]
	      };
	    }
	  }, {
	    key: 'updateData',
	    ...
	    value: function render() {
	      ...
	      if (this.state.building) {
	        buildStatus = _react2['default'].createElement(
	          'div',
	          { className: 'progress' },
	          _react2['default'].createElement('div', { className: 'determinate', style: barStyle })
	        );
	      } else {
	        buildStatus = _react2['default'].createElement(
	          'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LastBuilds = (function (_React$Component) {
	  function LastBuilds(props) {
	    _classCallCheck(this, LastBuilds);

	    _get(Object.getPrototypeOf(LastBuilds.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      builds: []
	    };
	  }

	  _inherits(LastBuilds, _React$Component);

	  _createClass(LastBuilds, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          builds.slice(1).map(function (build, i) {
	            ...
	            return _react2['default'].createElement('div', { style: style, className: className });
	          })
	        )
	      );
	    }
